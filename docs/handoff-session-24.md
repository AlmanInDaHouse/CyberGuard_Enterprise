...
- **Anchor commit:** `1bbb11f` (`docs(handoff): Session 24 close`) — substituted into the placeholder by an immediate follow-up commit per the two-commit anchor pattern (cf. Session 23 `9cc7ab6`/`63cd5fd`, Session 22 `1ec02d8`/`4702b8f`).
...
| Session 24 close (this handoff) | `1bbb11f` | `docs(handoff): Session 24 close`. Anchor SHA filled by the two-commit follow-up. |
