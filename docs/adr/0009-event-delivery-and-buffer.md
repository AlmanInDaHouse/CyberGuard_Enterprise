...
- [SPEC-005](../specs/SPEC-005-agent-process-telemetry-windows-etw.md) — First consumer of this ADR. Specifies the ring's parameters (size, batch-size and latency thresholds), the exact ClickHouse DDL, and the observable surface for `events_dropped_total`.
