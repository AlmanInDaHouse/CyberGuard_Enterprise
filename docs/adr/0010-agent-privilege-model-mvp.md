...
- SPEC-005 (forthcoming) — First consumer of this ADR. Specifies the acceptance criterion that validates clean-fail-on-insufficient-privilege, and is the first-use validation of the CI privilege assumption.
